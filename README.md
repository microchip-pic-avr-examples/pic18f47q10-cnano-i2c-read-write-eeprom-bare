...
2. Open the *pic18f47q10-cnano-i2c-read-write-eeprom-bare.X* project in MPLAB® X IDE.
...
This project is an illustration for a basic use case for writing and reading to and from an EEPROM using MSSP1.
